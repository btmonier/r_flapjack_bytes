      ...
      value: function buildTraits() {
        ...
        var _loop = function _loop(traitIndex) {
          ...
          if (traitName.includes("_#CAT")) {
            ...
            traitName.replace("_#CAT", ""), _readOnlyError("traitName");
          } else if (traitName.includes("_#NUM")) {
            traitType = TraitType.Numerical;
            traitName.replace("_#NUM", ""), _readOnlyError("traitName");
          } else {
          ...
          traitName.trim(), _readOnlyError("traitName");
  ...
  function GenotypeRenderer() {
    ...
    width, height, mapFileDom, genotypeFileDom, overviewWidth, overviewHeight, minGenotypeAutoWidth, minOverviewAutoWidth) {
      ...
      if (config.mapFileDom !== undefined) {
        ...
        // var mapFile = document.getElementById("mapfile").files[0];
        var mapFile = config.mapFileDom.files[0];
	  ...
	  // var genotypeFile = document.getElementById("genofile").files[0];
	  var genotypeFile = config.genotypeFileDom.files[0];
